...
Route::get('cashfree/pay', 'CashfreeController@initiatePayment');
Route::post('cashfree/response', 'CashfreeController@handlePaymentResponse');
...
Route::post('cashfree/payments/paycashfree', [CartManagementController::class, 'store'])->name('PayCashfree');
