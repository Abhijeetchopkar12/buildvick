                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-9">
                        <div class="course-single-banner-content">
                            ...
                            <div class="course-rating d-flex align-items-center text-white">
                                ...
                                <span class="rating-count font-14">{{ @$course->orderItems->count() }}
                                    {{ __('Students') }}</span>
                            </div>
                            ...
                            <ul class="nav nav-tabs tab-nav-list border-0" id="myTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" id="Review-tab" data-bs-toggle="tab" href="#Review" role="tab"
                                        aria-controls="Review" aria-selected="false">{{ __('Review') }}</a>
                                </li>
                                <li class="nav-item" role="presentation">
                        ...
                        <div class="course-info-box bg-white">
                            ...
                            ?>
                                ...
                                <div>
                                    ...
                                    <span class="course-left-duration color-deep-orange font-14"> <span
                                            class="iconify me-2 font-18" data-icon="clarity:alarm-clock-line"></span>

                                        {{ getLeftDuration($startDate, $endDate) }}
                                        {{ __('Left at this Price') }}!</span>
                                </div>
                                <div
                                    class="price-off font-12 font-medium color-hover d-flex align-items-center justify-content-center">
                                    {{ @$percentage }}% {{ __("off") }}</div>
                                @elseif($course->price <= $course->old_price)
                                    <div>
                                        <h4 class="d-flex align-items-center mb-1">
                                            ...
                                            <span
                                                class="text-decoration-line-through fw-normal font-16 color-gray ps-3">
                                                @if(get_currency_placement() == 'after')
                                    ...
                                    @php
                                    $percentage = number_format(((($course->old_price - $course->price) /
                                    $course->old_price) * 100), 2);
                                    @endphp
                                    <div
                                        class="price-off font-12 font-medium color-hover d-flex align-items-center justify-content-center">
                                        {{ $percentage }}% {{ __("off") }}</div>
                            ...
                            <button type="submit" class="theme-btn theme-button1 theme-button3 w-100 mb-30 addToCart "
                                data-course_id="{{ $course->id }} check" data-route="{{ route('student.addToCart') }}" onclick="window.location='http://localhost/buildvick2/student/cart-list'">
                                <span class="msgInfoChange">{{ __("Proceed to Checkout")  }} <i
                            ...
                            <!-- http://localhost/buildvick2/student/cart-list -->
                            <!-- <a href="http://localhost/buildvick2/student/cart-list" class="theme-btn theme-button1 theme-button3 w-100 mb-30 addToCart "
                             ...
                             <!-- <form method="POST" action="{{route('student.goToCheckout')}}"> 
                              @csrf 
                                <input type="submit" class="theme-btn theme-button1 theme-button3 w-100 mb-30 addToCart "
                                data-course_id="{{ $course->id }}" data-route="{{ route('student.addToCart') }}"
                                value="{{ __("Proceed to Checkout")  }}" name="proceed_to_checkout"> 
                            </form>  -->
                                <!-- <button class="theme-btn theme-button1 theme-button3 w-100 mb-30 addToCart " type="submit" data-course_id="{{ $course->id }}" data-route="{{ route('student.goToCheckout') }}" value="{{ __("Proceed to Checkout")  }}" name="proceed_to_checkout">
                                </button> -->
                             ...
                             <a href="{{ route('student.course-gift', $course->uuid) }}"
                                ...
                                <div class="mr-15">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" class="feather feather-gift text-gray">
                                ...
                                <div class="ml-5">
                                    ...
                                    <p class="font-12 text-gray">{{ __("Send this course as a gift to your friends") }}
                                    </p>
                                </div>
                             </a>
                                @endif
                             ...
                             <div class="course-includes-box mb-30">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <span>{{@$course->lectures->count() > 0 ? @$course->video_duration : '0'}}
                                            {{ __('Video Lectures') }}</span>
                                    </li>
                                    @endif
                                    <li>
                                        <span class="iconify"
                                    ...
                                    <li>
                                        ...
                                        <span>{{ @$course->resources->count() }}
                                            {{ __('Downloadable Resources') }}</span>
                                    </li>
                                    <li>
                                        <span class="iconify" data-icon="bytesize:clock"></span>
                            ...
                            @if(@Auth::user() && Auth::user()->is_affiliator == AFFILIATOR &&
                            get_option('referral_status'))
                            <div class="course-info-box-affiliate-link-copy position-relative">
                                ...
                                <div class="input-group">
                                    ...
                                    <button type="button" class="btn affiliate-copy-btn border-0 position-absolute"
                                        onclick="copyToClipboard('ref_link')" title="{{ __('Copy to Clipboard') }}">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <ul class="share-course-list">
                    ...
                    <li><a
                            href="https://www.linkedin.com/shareArticle?url={{ route('course-details', $course->slug) }}"><span
