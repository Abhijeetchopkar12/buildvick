                ...
                <div class="email-inbox__area bg-style admin-dashboard-payment-method">
                    ...
                    <form action="{{ route('settings.save.setting') }}" method="post" class="form-horizontal"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <select name="paypal_currency"
                                                class="form-control paypal_currency currency">
                                                @foreach(getCurrency() as $code => $currency)
                                                <option value="{{$code}}"
                                                    {{ get_option('paypal_currency') == $code ? 'selected' : '' }}>
                                                    {{$currency}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="number" step="any" min="0" name="paypal_conversion_rate"
                                                value="{{ get_option('paypal_conversion_rate') ? get_option('paypal_conversion_rate') : 1 }}"
                                                class="form-control">
                                            <span
                                                class="input-group-text paypal_append_currency append_currency"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <select name="stripe_currency"
                                                class="form-control stripe_currency currency">
                                                @foreach(getCurrency() as $code => $currency)
                                                <option value="{{$code}}"
                                                    {{ get_option('stripe_currency') == $code ? 'selected' : '' }}>
                                                    {{$currency}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group mb-3">
                                            <span
                                                class="input-group-text">{{ '1 ' . get_currency_symbol() . ' = ' }}</span>
                                            <input type="number" step="any" min="0" name="stripe_conversion_rate"
                                                value="{{ get_option('stripe_conversion_rate') ? get_option('stripe_conversion_rate') : 1 }}"
                                                class="form-control">
                                            <span
                                                class="input-group-text stripe_append_currency append_currency"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <select name="razorpay_currency"
                                                class="form-control razorpay_currency currency">
                                                @foreach(getCurrency() as $code => $currency)
                                                <option value="{{$code}}"
                                                    {{ get_option('razorpay_currency') == $code ? 'selected' : '' }}>
                                                    {{$currency}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group mb-3">
                                            <span
                                                class="input-group-text">{{ '1 ' . get_currency_symbol() . ' = ' }}</span>
                                            <input type="number" step="any" min="0" name="razorpay_conversion_rate"
                                                value="{{ get_option('razorpay_conversion_rate') ? get_option('razorpay_conversion_rate') : 1 }}"
                                                class="form-control">
                                            <span
                                                class="input-group-text razorpay_append_currency append_currency"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                            ...
                            <div class="payment-getaway admin-dashboard-payment-content-box-right col-md-6 border p-3">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            <label>{{ __('Currency ISO Code') }} </label>
                                            <select name="sslcommerz_currency"
                                                class="form-control sslcommerz_currency currency">
                                                @foreach(getCurrency() as $code => $currency)
                                                <option value="{{$code}}"
                                                    {{ get_option('sslcommerz_currency') == $code ? 'selected' : '' }}>
                                                    {{$currency}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group mb-3">
                                            <span
                                                class="input-group-text">{{ '1 ' . get_currency_symbol() . ' = ' }}</span>
                                            <input type="number" step="any" min="0" name="sslcommerz_conversion_rate"
                                                value="{{ get_option('sslcommerz_conversion_rate') ? get_option('sslcommerz_conversion_rate') : 1 }}"
                                                class="form-control">
                                            <span
                                                class="input-group-text sslcommerz_append_currency append_currency"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                            ...
                            <div class="payment-getaway admin-dashboard-payment-content-box-left col-md-6 border p-3">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            <label>{{ __('Currency ISO Code') }} </label>
                                            <select name="mollie_currency"
                                                class="form-control mollie_currency currency">
                                                @foreach(getCurrency() as $code => $currency)
                                                <option value="{{$code}}"
                                                    {{ get_option('mollie_currency') == $code ? 'selected' : '' }}>
                                                    {{$currency}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group mb-3">
                                            <span
                                                class="input-group-text">{{ '1 ' . get_currency_symbol() . ' = ' }}</span>
                                            <input type="number" step="any" min="0" name="mollie_conversion_rate"
                                                value="{{ get_option('mollie_conversion_rate') ? get_option('mollie_conversion_rate') : 1 }}"
                                                class="form-control">
                                            <span
                                                class="input-group-text mollie_append_currency append_currency"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <input type="text" name="MOLLIE_KEY" value="{{ get_option('MOLLIE_KEY') }}"
                                                class="form-control">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <select name="im_currency" class="form-control im_currency currency">
                                                @foreach(getCurrency() as $code => $currency)
                                                <option value="{{$code}}"
                                                    {{ get_option('im_currency') == $code ? 'selected' : '' }}>
                                                    {{$currency}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group mb-3">
                                            <span
                                                class="input-group-text">{{ '1 ' . get_currency_symbol() . ' = ' }}</span>
                                            <input type="number" step="any" min="0" name="im_conversion_rate"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <select name="im_status" class="form-control">
                                                <option value=""> {{ __('Select Option') }}</option>
                                                <option value="1" {{ get_option('im_status') == 1 ? 'selected' : '' }}>
                                                    {{ __('Enable') }} </option>
                                                <option value="0"
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <input type="text" name="IM_API_KEY" value="{{ get_option('IM_API_KEY') }}"
                                                class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <input type="text" name="IM_AUTH_TOKEN"
                                                value="{{ get_option('IM_AUTH_TOKEN') }}" class="form-control">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row justify-content-center px-3 pb-0 mb-3">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <select name="paystack_currency"
                                                class="form-control paystack_currency currency">
                                                @foreach(getCurrency() as $code => $currency)
                                                <option value="{{$code}}"
                                                    {{ get_option('paystack_currency') == $code ? 'selected' : '' }}>
                                                    {{$currency}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="number" step="any" min="0" name="paystack_conversion_rate"
                                                value="{{ get_option('paystack_conversion_rate') ? get_option('paystack_conversion_rate') : 1 }}"
                                                class="form-control">
                                            <span
                                                class="input-group-text paystack_append_currency append_currency"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <select name="paystack_status" class="form-control">
                                                <option value=""> {{ __('Select Option') }}</option>
                                                <option value="1"
                                                    {{ get_option('paystack_status') == 1 ? 'selected' : '' }}>
                                                    {{ __('Enable') }} </option>
                                                <option value="0"
                                                    {{ get_option('paystack_status') == '0' ? 'selected' : '' }}>
                                                    {{ __('Disable') }} </option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <input type="text" name="PAYSTACK_PUBLIC_KEY"
                                                value="{{ get_option('PAYSTACK_PUBLIC_KEY') }}" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <input type="text" name="PAYSTACK_SECRET_KEY"
                                                value="{{ get_option('PAYSTACK_SECRET_KEY') }}" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div
                                class="payment-getaway payment-getaway admin-dashboard-payment-content-box-right col-md-6 border p-3">
                                <div class="row mb-3">

                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            <label>{{ __('Currency ISO Code') }} </label>
                                            <select name="mercado_currency"
                                                class="form-control mercado_currency currency">
                                                @foreach(getCurrency() as $code => $currency)
                                                <option value="{{$code}}"
                                                    {{ get_option('mercado_currency') == $code ? 'selected' : '' }}>
                                                    {{$currency}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="number" step="any" min="0" name="mercado_conversion_rate"
                                                value="{{ get_option('mercado_conversion_rate') ? get_option('mercado_conversion_rate') : 1 }}"
                                                class="form-control">
                                            <span
                                                class="input-group-text mercado_append_currency append_currency"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <select name="mercado_status" class="form-control">
                                                <option value=""> {{ __('Select Option') }}</option>
                                                <option value="1"
                                                    {{ get_option('mercado_status') == 1 ? 'selected' : '' }}>
                                                    {{ __('Enable') }} </option>
                                                <option value="0"
                                                    {{ get_option('mercado_status') == '0' ? 'selected' : '' }}>
                                                    {{ __('Disable') }} </option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <input type="text" name="MERCADO_PAGO_CLIENT_ID"
                                                value="{{ get_option('MERCADO_PAGO_CLIENT_ID') }}" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <input type="text" name="MERCADO_PAGO_CLIENT_SECRET"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <select name="flutterwave_currency" class="form-control currency">
                                                @foreach(getCurrency() as $code => $currency)
                                                <option value="{{$code}}"
                                                    {{ get_option('flutterwave_currency') == $code ? 'selected' : '' }}>
                                                    {{$currency}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="number" step="any" min="0" name="flutterwave_conversion_rate"
                                                value="{{ get_option('flutterwave_conversion_rate') ? get_option('flutterwave_conversion_rate') : 1 }}"
                                                class="form-control">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <select name="flutterwave_status" class="form-control">
                                                <option value=""> {{ __('Select Option') }}</option>
                                                <option value="1"
                                                    {{ get_option('flutterwave_status') == 1 ? 'selected' : '' }}>
                                                    {{ __('Enable') }} </option>
                                                <option value="0"
                                                    {{ get_option('flutterwave_status') == '0' ? 'selected' : '' }}>
                                                    {{ __('Disable') }} </option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <input type="text" name="FLW_PUBLIC_KEY"
                                                value="{{ get_option('FLW_PUBLIC_KEY') }}" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <input type="text" name="FLW_SECRET_KEY"
                                                value="{{ get_option('FLW_SECRET_KEY') }}" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <input type="text" name="FLW_SECRET_HASH"
                                                value="{{ get_option('FLW_SECRET_HASH') }}" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <select name="coinbase_currency" class="form-control currency">
                                                @foreach(getCurrency() as $code => $currency)
                                                <option value="{{$code}}"
                                                    {{ get_option('coinbase_currency') == $code ? 'selected' : '' }}>
                                                    {{$currency}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="number" step="any" min="0" name="coinbase_conversion_rate"
                                                value="{{ get_option('coinbase_conversion_rate') ? get_option('coinbase_conversion_rate') : 1 }}"
                                                class="form-control">
                                            <span class="input-group-text append_currency"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <select name="coinbase_status" class="form-control">
                                                <option value=""> {{ __('Select Option') }}</option>
                                                <option value="1"
                                                    {{ get_option('coinbase_status') == 1 ? 'selected' : '' }}>
                                                    {{ __('Enable') }} </option>
                                                <option value="0"
                                                    {{ get_option('coinbase_status') == '0' ? 'selected' : '' }}>
                                                    {{ __('Disable') }} </option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <input type="text" name="coinbase_key"
                                                value="{{ get_option('coinbase_key') }}" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <select name="zitopay_currency" class="form-control currency">
                                                @foreach(getCurrency() as $code => $currency)
                                                <option value="{{$code}}"
                                                    {{ get_option('zitopay_currency') == $code ? 'selected' : '' }}>
                                                    {{$currency}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="number" step="any" min="0" name="zitopay_conversion_rate"
                                                value="{{ get_option('zitopay_conversion_rate') ? get_option('zitopay_conversion_rate') : 1 }}"
                                                class="form-control">
                                            <span class="input-group-text append_currency"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <select name="zitopay_status" class="form-control">
                                                <option value=""> {{ __('Select Option') }}</option>
                                                <option value="1"
                                                    {{ get_option('zitopay_status') == 1 ? 'selected' : '' }}>
                                                    {{ __('Enable') }} </option>
                                                <option value="0"
                                                    {{ get_option('zitopay_status') == '0' ? 'selected' : '' }}>
                                                    {{ __('Disable') }} </option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <input type="text" name="zitopay_username"
                                                value="{{ get_option('zitopay_username') }}" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <select name="iyzipay_currency" class="form-control currency">
                                                @foreach(getCurrency() as $code => $currency)
                                                <option value="{{$code}}"
                                                    {{ get_option('iyzipay_currency') == $code ? 'selected' : '' }}>
                                                    {{$currency}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="number" step="any" min="0" name="iyzipay_conversion_rate"
                                                value="{{ get_option('iyzipay_conversion_rate') ? get_option('iyzipay_conversion_rate') : 1 }}"
                                                class="form-control">
                                            <span class="input-group-text append_currency"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <select name="iyzipay_status" class="form-control">
                                                <option value=""> {{ __('Select Option') }}</option>
                                                <option value="1"
                                                    {{ get_option('iyzipay_status') == 1 ? 'selected' : '' }}>
                                                    {{ __('Enable') }} </option>
                                                <option value="0"
                                                    {{ get_option('iyzipay_status') == '0' ? 'selected' : '' }}>
                                                    {{ __('Disable') }} </option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <input type="text" name="iyzipay_key"
                                                value="{{ get_option('iyzipay_key') }}" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <input type="text" name="iyzipay_secret"
                                                value="{{ get_option('iyzipay_secret') }}" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <select name="bitpay_currency" class="form-control currency">
                                                @foreach(getCurrency() as $code => $currency)
                                                <option value="{{$code}}"
                                                    {{ get_option('bitpay_currency') == $code ? 'selected' : '' }}>
                                                    {{$currency}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="number" step="any" min="0" name="bitpay_conversion_rate"
                                                value="{{ get_option('bitpay_conversion_rate') ? get_option('bitpay_conversion_rate') : 1 }}"
                                                class="form-control">
                                            <span class="input-group-text append_currency"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <select name="bitpay_status" class="form-control">
                                                <option value=""> {{ __('Select Option') }}</option>
                                                <option value="1"
                                                    {{ get_option('bitpay_status') == 1 ? 'selected' : '' }}>
                                                    {{ __('Enable') }} </option>
                                                <option value="0"
                                                    {{ get_option('bitpay_status') == '0' ? 'selected' : '' }}>
                                                    {{ __('Disable') }} </option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <input type="text" name="bitpay_key" value="{{ get_option('bitpay_key') }}"
                                                class="form-control">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <select name="braintree_currency" class="form-control currency">
                                                @foreach(getCurrency() as $code => $currency)
                                                <option value="{{$code}}"
                                                    {{ get_option('braintree_currency') == $code ? 'selected' : '' }}>
                                                    {{$currency}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="number" step="any" min="0" name="braintree_conversion_rate"
                                                value="{{ get_option('braintree_conversion_rate') ? get_option('braintree_conversion_rate') : 1 }}"
                                                class="form-control">
                                            <span class="input-group-text append_currency"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <select name="braintree_status" class="form-control">
                                                <option value=""> {{ __('Select Option') }}</option>
                                                <option value="1"
                                                    {{ get_option('braintree_status') == 1 ? 'selected' : '' }}>
                                                    {{ __('Enable') }} </option>
                                                <option value="0"
                                                    {{ get_option('braintree_status') == '0' ? 'selected' : '' }}>
                                                    {{ __('Disable') }} </option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <input type="text" name="braintree_merchant_id"
                                                value="{{ get_option('braintree_merchant_id') }}" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <input type="text" name="braintree_public_key"
                                                value="{{ get_option('braintree_public_key') }}" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group text-black">
                                            ...
                                            <input type="text" name="braintree_private_key"
                                                value="{{ get_option('braintree_private_key') }}" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="payment-getaway admin-dashboard-payment-content-box-left col-md-6 border p-3">
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <div class="form-group text-black">
                                        <label>{{ __('Status') }} </label>
                                        <select name="cashfree_status" class="form-control">
                                            <option value=""> {{ __('Select Option') }}</option>
                                            <option value="1"
                                                {{ get_option('cashfree_status') == 1 ? 'selected' : '' }}>
                                                {{ __('Enable') }} </option>
                                            <option value="0"
                                                {{ get_option('cashfree_status') == '0' ? 'selected' : '' }}>
                                                {{ __('Disable') }} </option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group text-black">
                                        <label> {{ __('Cashfree Public Key') }} </label>
                                        <input type="text" name="cashfree_public_key"
                                            value="{{ get_option('cashfree_public_key') }}" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <div class="form-group text-black">
                                        <label> {{ __('Cashfree Private Secret') }} </label>
                                        <input type="text" name="cashfree_private_key"
                                            value="{{ get_option('cashfree_private_key') }}" class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
