...
class CartManagementController extends Controller
{
    ...
    public function cartList()
    {
        ...
        return redirect()->to(route('student.checkout'));
...
//         return view('frontend.student.cart.checkout', $data);
    ...
    //             if (empty(env('CASHFREE_CLIENT_ID')) || empty(env('CASHFREE_SECRET'))) {
    //                 $this->showToastrMessage('error', __('Cashfree payment gateway is off!'));
    //                 return redirect()->back();
    //             }
    //         }
