...
class MainIndexController extends Controller
{
    public function index()
    {
        if (file_exists(storage_path('installed'))) {
            ...
            return redirect()->to('/course-details/introduction-to-light-gauge-steel-framing-lgsf-industry');
    ...
    public function home($slug)
    {
        ...
        if (!is_null($affilate_request)) {
            ...
            $data['ref_link'] = route('homepeg') . '?code=' . $ref_cod;
        ...
        return view('frontend.course.homepeg', $data);
